...
image::BeginnersGuide/Wwise/wwise_version.png[Select Wwise version screenshot, title=WWise UI as of September 2025]
...
image::BeginnersGuide/Wwise/wwise_packages.png[Select Wwise packages screenshot, title=Required Packages as of September 2025]
...
image::BeginnersGuide/Wwise/wwise_noplugin.png[Do not select any Wwise plugins screenshot]
